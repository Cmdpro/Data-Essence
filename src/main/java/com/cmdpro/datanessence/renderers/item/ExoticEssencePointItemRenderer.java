...
public class ExoticEssencePointItemRenderer extends DatabankItemRenderer<ExoticEssencePointItem> {
    public static final ModelLayerLocation modelLocation = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(DataNEssence.MOD_ID, "exotic_essence_point_item"), "main");
