...
public class EssenceTypeRegistry {
    ...
    public static final Supplier<EssenceType> ESSENCE = register("essence", () -> new EssenceType(Component.translatable("datanessence.essence_types.essence"), 1, 0xe236ef, "gui.essence_bar.essence", EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 0, 56), EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 0, 0))); // Artifice, industry, electricity
    public static final Supplier<EssenceType> LUNAR_ESSENCE = register("lunar_essence", () -> new EssenceType(Component.translatable("datanessence.essence_types.lunar_essence"), 3, 0xf5fbc0, "gui.essence_bar.lunar_essence", EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 11, 56), EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 11, 0))); // Transformation, the moon, rule-bending
    public static final Supplier<EssenceType> NATURAL_ESSENCE = register("natural_essence", () -> new EssenceType(Component.translatable("datanessence.essence_types.natural_essence"), 5, 0x57f36c, "gui.essence_bar.natural_essence", EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 22, 56), EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 22, 0))); // Nature, life, the world
