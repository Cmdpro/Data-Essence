...
public class EssenceTypeRegistry {
    ...
    public static final Supplier<EssenceType> ESSENCE = register("essence", () -> new EssenceType(Component.translatable("datanessence.essence_types.essence"), 1, 0xe236ef, "gui.essence_bar.essence", "gui.essence_bar.essence_with_max", EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 0, 56), EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 0, 0))); // Artifice, industry, electricity
    ...
    public static final Supplier<EssenceType> NATURAL_ESSENCE = register("natural_essence", () -> new EssenceType(Component.translatable("datanessence.essence_types.natural_essence"), 5, 0x57f36c, "gui.essence_bar.natural_essence", "gui.essence_bar.natural_essence_with_max", EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 22, 56), EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 22, 0))); // Nature, life, the world
    public static final Supplier<EssenceType> EXOTIC_ESSENCE = register("exotic_essence", () -> new EssenceType(Component.translatable("datanessence.essence_types.exotic_essence"), 7, 0xe7fcf9, "gui.essence_bar.exotic_essence", "gui.essence_bar.exotic_essence_with_max", EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 33, 56), EssenceType.createLocation(EssenceType.ESSENCE_BAR_LOCATION, 33, 0))); // Stars, space, dreams
