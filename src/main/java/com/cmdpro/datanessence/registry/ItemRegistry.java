...
public class ItemRegistry {
    ...
    public static final Supplier<Item> COAL_LUMP = register("coal_lump", () -> new FuelItem(new Item.Properties(), 180)); // close to the actual result of 1600/9, but a round number.
