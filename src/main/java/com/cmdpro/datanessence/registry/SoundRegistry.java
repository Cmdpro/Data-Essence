...
public class SoundRegistry {
    ...
    public static final Holder<SoundEvent> FALLING_MOON_CHARGE_1 = createBasicSound("item.falling_moon.charge1");
    public static final Holder<SoundEvent> FALLING_MOON_CHARGE_2 = createBasicSound("item.falling_moon.charge2");
    public static final Holder<SoundEvent> FALLING_MOON_CHARGE_3 = createBasicSound("item.falling_moon.charge3");
