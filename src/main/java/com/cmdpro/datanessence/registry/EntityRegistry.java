...
public class EntityRegistry {
    ...
    public static final Supplier<EntityType<AncientCombatUnit>> ANCIENT_COMBAT_UNIT = register("ancient_combat_unit", () -> EntityType.Builder.of((EntityType.EntityFactory<AncientCombatUnit>) AncientCombatUnit::new, MobCategory.MONSTER).sized(0.8F, 2F).build(DataNEssence.MOD_ID + ":" + "ancient_combat_unit"));
