...
public class ComputerFileTypeRegistry {
    public static final DeferredRegister<ComputerFileType> COMPUTER_FILE_TYPES = DeferredRegister.create(new ResourceLocation(DataNEssence.MOD_ID, "computer_file_types"), DataNEssence.MOD_ID);
