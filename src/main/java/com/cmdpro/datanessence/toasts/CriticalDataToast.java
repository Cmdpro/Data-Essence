...
public class CriticalDataToast implements Toast {
    ...
    public Visibility render(GuiGraphics pGuiGraphics, ToastComponent pToastComponent, long pTimeSinceLastVisible) {
        ...
        int i = 16776960;
        if (list.size() == 1) {
            pGuiGraphics.drawString(pToastComponent.getMinecraft().font, Component.translatable("item.datanessence.datatablet.criticaldataunlocked"), 30, 7, i | -16777216, false);
            ...
            if (pTimeSinceLastVisible < 1500L) {
                ...
                pGuiGraphics.drawString(pToastComponent.getMinecraft().font, Component.translatable("item.datanessence.datatablet.criticaldataunlocked"), 30, 11, i | k, false);
            } else {
