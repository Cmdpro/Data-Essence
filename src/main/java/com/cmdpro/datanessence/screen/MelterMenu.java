...
public class MelterMenu extends AbstractContainerMenu implements IDataNEssenceMenuHelper {
    @Override
    ...
    public MelterMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }
    public MelterMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(MenuRegistry.MELTER_MENU.get(), pContainerId);
        blockEntity = ((MelterBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockRegistry.MELTER.get());
    }
