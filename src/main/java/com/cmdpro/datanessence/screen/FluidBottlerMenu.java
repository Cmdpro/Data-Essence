...
public class FluidBottlerMenu extends AbstractContainerMenu implements IDataNEssenceMenuHelper {
    @Override
    ...
    public final FluidBottlerBlockEntity blockEntity;
    private final Level level;
    public FluidBottlerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public FluidBottlerMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.addSlot(new SlotItemHandler(handler, 0, 62, 22));
