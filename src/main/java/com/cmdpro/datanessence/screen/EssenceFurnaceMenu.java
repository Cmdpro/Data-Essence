...
public class EssenceFurnaceMenu extends AbstractContainerMenu implements IDataNEssenceMenuHelper {
    @Override
    ...
    public EssenceFurnaceMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockRegistry.ESSENCE_FURNACE.get());
    }
