...
public class ClientEntries {
    ...
    static {
        ...
        }, null, Component.literal("Cool Entry 1")));
        ...
        }, new ResourceLocation(DataNEssence.MOD_ID, "test1"), Component.literal("Cool Entry 2")));
        entries.put(new ResourceLocation(DataNEssence.MOD_ID, "test3"), new Entry(new ResourceLocation(DataNEssence.MOD_ID, "test3"), ItemInit.DATATABLET.get(), -1, 2, new Page[] {}, new ResourceLocation(DataNEssence.MOD_ID, "test1"), Component.literal("Cool Entry 3")));
        entries.put(new ResourceLocation(DataNEssence.MOD_ID, "test4"), new Entry(new ResourceLocation(DataNEssence.MOD_ID, "test4"), ItemInit.DATATABLET.get(), 1, 2, new Page[] {}, new ResourceLocation(DataNEssence.MOD_ID, "test1"), Component.literal("Cool Entry 4")));
        entries.put(new ResourceLocation(DataNEssence.MOD_ID, "test5"), new Entry(new ResourceLocation(DataNEssence.MOD_ID, "test5"), ItemInit.DATATABLET.get(), 3, 2, new Page[] {}, new ResourceLocation(DataNEssence.MOD_ID, "test1"), Component.literal("Cool Entry 5")));
