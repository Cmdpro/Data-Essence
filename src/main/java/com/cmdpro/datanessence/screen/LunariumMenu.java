...
public class LunariumMenu extends AbstractContainerMenu implements IDataNEssenceMenuHelper {
    @Override
    ...
    public final LunariumBlockEntity blockEntity;
    private final Level level;
    public LunariumMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }
    public LunariumMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(MenuRegistry.LUNARIUM_MENU.get(), pContainerId);
        blockEntity = ((LunariumBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockRegistry.LUNARIUM.get());
    }
