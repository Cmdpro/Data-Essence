...
public class IndustrialPlantSiphonMenu extends AbstractContainerMenu implements IDataNEssenceMenuHelper {
    @Override
    ...
    public final IndustrialPlantSiphonBlockEntity blockEntity;
    private final Level level;
    public IndustrialPlantSiphonMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }
    public IndustrialPlantSiphonMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(MenuRegistry.INDUSTRIAL_PLANT_SIPHON_MENU.get(), pContainerId);
        blockEntity = ((IndustrialPlantSiphonBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, BlockRegistry.INDUSTRIAL_PLANT_SIPHON.get());
    }
