...
import com.cmdpro.datanessence.renderers.ItemPointItemRenderer;
...
public class ItemPointItem extends BlockItem implements GeoItem {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new ItemPointItemRenderer();
            @Override
