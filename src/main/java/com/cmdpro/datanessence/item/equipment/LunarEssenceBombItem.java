...
public class LunarEssenceBombItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> components, TooltipFlag flag) {
        ...
        components.add(Component.translatable("item.datanessence.lunar_essence_bomb.info").withStyle(Style.EMPTY.withColor(EssenceTypeRegistry.LUNAR_ESSENCE.get().getColor())));
    }
}
