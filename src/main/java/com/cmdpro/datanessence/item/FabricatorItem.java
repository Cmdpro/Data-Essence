...
import com.cmdpro.datanessence.renderers.FabricatorItemRenderer;
...
public class FabricatorItem extends BlockItem implements GeoItem {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new FabricatorItemRenderer();
