...
public class EnderPearlDestinationItemRenderer extends DatabankItemRenderer<BlockItem> {
    public static final ModelLayerLocation modelLocation = new ModelLayerLocation(DataNEssence.locate("ender_pearl_destination_item"), "main");
    public EnderPearlDestinationItemRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet modelSet) {
