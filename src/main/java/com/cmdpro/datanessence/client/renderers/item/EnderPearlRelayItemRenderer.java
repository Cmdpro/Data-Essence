...
public class EnderPearlRelayItemRenderer extends DatabankItemRenderer<BlockItem> {
    public static final ModelLayerLocation modelLocation = new ModelLayerLocation(DataNEssence.locate("ender_pearl_relay_item"), "main");
    public EnderPearlRelayItemRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet modelSet) {
