...
public class EnderPearlCaptureItemRenderer extends DatabankItemRenderer<BlockItem> {
    public static final ModelLayerLocation modelLocation = new ModelLayerLocation(DataNEssence.locate("ender_pearl_capture_item"), "main");
    public EnderPearlCaptureItemRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet modelSet) {
